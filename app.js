...
* Question routes
*/
app.get('/question/create', questionController.getQuestionForm);
app.post('/question/create', questionController.postQuestion);
app.get('/question/list', questionController.list);

/**
* Test routes
*/
app.get('/test/start', testController.startTest);
app.get('/test/load', testController.load);
app.post('/test/start', testController.finish);
